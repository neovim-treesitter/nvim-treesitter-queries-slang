# nvim-treesitter-queries-slang

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-slang/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-slang/actions/workflows/validate.yml)

Neovim tree-sitter queries for **slang**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-slang",
...
- [ ] Changes are scoped to `slang` — do not include files for other languages
